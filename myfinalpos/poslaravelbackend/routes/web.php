...
use App\Http\Controllers\Pos\RegisterReadingPageController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/pos/readings', [RegisterReadingPageController::class, 'index'])->name('pos.readings');
    Route::get('/pos/readings/status', [RegisterReadingPageController::class, 'status'])->name('pos.readings.status');
    Route::post('/pos/readings/open', [RegisterReadingPageController::class, 'openSession'])->name('pos.readings.open');
    Route::post('/pos/readings/x', [RegisterReadingPageController::class, 'xReading'])->name('pos.readings.x');
    Route::post('/pos/readings/z', [RegisterReadingPageController::class, 'zReading'])->name('pos.readings.z');
