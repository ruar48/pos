...
/// Prompts for the refund PIN. Returns the entered PIN, or null if the
/// user cancelled.
...
class _RefundPinDialogState extends State<_RefundPinDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: const Text('Refund PIN Required'),
      content: SizedBox(
        width: 320,
        child: Column(
          ...
          children: [
            const Text(
              ...
              'This is separate from the cash drawer PIN.',
